...
Pre Bind Endorsement
    ...
    FOR    ${index}    IN RANGE    1    10
        ${subjective_exist}=    Execute Javascript    return document.getElementById('ctl00_ctl00_PartContentPlaceHolderMain_ContentPlaceHolderMain_ctrlSubjectivities_repeaterSubjectivities_ctl0${index}_cbMandatory') != null;
        IF    ${subjective_exist} == True
            ${subjective_checked}=    Execute Javascript    return document.getElementById('ctl00_ctl00_PartContentPlaceHolderMain_ContentPlaceHolderMain_ctrlSubjectivities_repeaterSubjectivities_ctl0${index}_cbMandatory').checked;
            IF    ${subjective_checked} == True
                Wait Until Keyword Succeeds    3x    2s    Execute Javascript    document.getElementById('ctl00_ctl00_PartContentPlaceHolderMain_ContentPlaceHolderMain_ctrlSubjectivities_repeaterSubjectivities_ctl0${index}_cbSatisfied').click()
                Sleep    1s
            END
        ELSE
            BREAK
...
Ready To Bind
    ...
    FOR    ${index}    IN RANGE    1    10
        ${subjective_exist}=    Execute Javascript    return document.getElementById('ctl00_ctl00_PartContentPlaceHolderMain_ContentPlaceHolderMain_ctrlCheckSubjectivities_repeaterSubjectivities_ctl0${index}_cbMandatory') != null;
        IF    ${subjective_exist} == True
            ${subjective_checked}=    Execute Javascript    return document.getElementById('ctl00_ctl00_PartContentPlaceHolderMain_ContentPlaceHolderMain_ctrlCheckSubjectivities_repeaterSubjectivities_ctl0${index}_cbMandatory').checked;
            IF    ${subjective_checked} == True
                Wait Until Keyword Succeeds    3x    2s    Execute Javascript    document.getElementById('ctl00_ctl00_PartContentPlaceHolderMain_ContentPlaceHolderMain_ctrlCheckSubjectivities_repeaterSubjectivities_ctl0${index}_cbSatisfied').click()
                Sleep    1s
            END
        ELSE
            BREAK
