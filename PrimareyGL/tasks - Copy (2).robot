...
Pre Bind Endorsement
    ...
    FOR    ${index}    IN RANGE    1    10
        ${subjective_exist}=    Run Keyword And Return Status
        ...    Wait Until Keyword Succeeds    3x    2s    Element Should Be Visible
        ...
        IF    ${subjective_exist} == True
            ${subjective_checked}=    Run Keyword And Return Status
            ...    Wait Until Keyword Succeeds    3x    2s    Checkbox Should Be Selected
            ...    (//input[@id='ctl00_ctl00_PartContentPlaceHolderMain_ContentPlaceHolderMain_ctrlSubjectivities_repeaterSubjectivities_ctl0${index}_cbMandatory'])[1]
            IF    ${subjective_checked} == True
                Wait Until Keyword Succeeds    3x    2s    Select Checkbox
...
Ready To Bind
    ...
    FOR    ${index}    IN RANGE    1    10
        ...
        ...    (//input[@id='ctl00_ctl00_PartContentPlaceHolderMain_ContentPlaceHolderMain_ctrlCheckSubjectivities_repeaterSubjectivities_ctl0${index}_cbMandatory'])[1]
        IF    ${subjective_exist} == True
            ${subjective_checked}=    Is Checkbox Selected
            ...    (//input[@id='ctl00_ctl00_PartContentPlaceHolderMain_ContentPlaceHolderMain_ctrlCheckSubjectivities_repeaterSubjectivities_ctl0${index}_cbMandatory'])[1]
            IF    ${subjective_checked} == True
                Select Checkbox
                ...    (//input[@id='ctl00_ctl00_PartContentPlaceHolderMain_ContentPlaceHolderMain_ctrlCheckSubjectivities_repeaterSubjectivities_ctl0${index}_cbSatisfied'])[1]
            END
        ELSE
            BREAK
        END
    ...
    FOR    ${index}    IN RANGE    10    20
        ${subjective_exist}=    Is Element Visible
        ...    (//input[@id='ctl00_ctl00_PartContentPlaceHolderMain_ContentPlaceHolderMain_ctrlCheckSubjectivities_repeaterSubjectivities_ctl${index}_cbMandatory'])[1]
        IF    ${subjective_exist} == True
            ${subjective_checked}=    Is Checkbox Selected
            ...    (//input[@id='ctl00_ctl00_PartContentPlaceHolderMain_ContentPlaceHolderMain_ctrlCheckSubjectivities_repeaterSubjectivities_ctl${index}_cbMandatory'])[1]
            IF    ${subjective_checked} == True
                Select Checkbox
                ...    (//input[@id='ctl00_ctl00_PartContentPlaceHolderMain_ContentPlaceHolderMain_ctrlCheckSubjectivities_repeaterSubjectivities_ctl${index}_cbSatisfied'])[1]
            END
        ELSE
            BREAK
        END
