...
Oil And Gas
    ...
    ${excel_rows}=    Read Worksheet    OilAndGas
    Log    ${excel_rows}
...
Login to App
    ...
    Safe Click Element    xpath=(//a[contains(text(),'Oil And Gas')])[1]
    Sleep    10s
    Safe Click Element
...
Fill Insured Details[First Run]
    ...
    ...    ${department}
    ${producing_office}=    Get From Dictionary    ${current_row}    G
    Select From List By Label
    ...    (//select[@id='ctl00_ctl00_PartContentPlaceHolderMain_ContentPlaceHolderMain_DropDownListProducingOffice'])[1]
    ...    Madrid
    Select From List By Label
...
Fill Pricing Details[First Run]
    ...
    ...    ${service_interuption}
    ${bi_basis}=    Get From Dictionary    ${current_row}    AO
    Select From List By Label
    ...
    ...    Fixed Costs
    ${bi_period}=    Get From Dictionary    ${current_row}    AO
    Select From List By Label
    ...
    ...    5
    ${ip_start_date}=    Get From Dictionary    ${current_row}    AO
    Select From List By Label
    ...
    Input Text When Element Is Visible
    ...    (//input[@id='ctl00_ctl00_ctl00_ctl00_PartContentPlaceHolderMain_ContentPlaceHolderMain_ContentPlaceHolderPolicyMain_ContentPlaceHolderMain_ctrlTria_txtAllOther'])[1]
    ...    100
    Clear Element Text
...
Book
    ...
    Input Text When Element Is Visible
    ...    (//input[@id='ctl00_ctl00_ctl00_PartContentPlaceHolderMain_ContentPlaceHolderMain_ContentPlaceHolderPolicyMain_ctrlBook_TextBoxUmr'])[1]
    ...    ${umr}
    Safe Click Element    (//span[@class='ui-button-text'][normalize-space()='No'])[1]
    Sleep    5s
...
Account[Renewal]
    ...
    Set Global Variable
    ...    ${url_ra}
    ...    https://stage-riskengineering.grsazr.lmig.com/RiskAppraisal/${account_number}/Edit
